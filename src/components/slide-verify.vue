<template>
    <div class="slide-verify" id="slideVerify" onselectstart="return false;">
        ...
        <transition name="fade"  :duration="{ enter: 800, leave: 0 }">
            <div class="infoClass" v-show="containerSuccess" style="background:#3AB71C;">
                <i class="el-icon-check iconStyle"></i>
                <span>验证通过</span>
            </div>
        </transition>
        <transition name="fade"  :duration="{ enter: 800, leave: 0 }">
            <div class="infoClass" v-show="containerFail" style="background:#F54A4A;">
                <i class="el-icon-close iconStyle"></i>
                <span>验证失败</span>
            </div>
        </transition>
        ...
        <div class="slide-verify-slider" :class="{'container-active': containerActive, 'container-success': containerSuccess, 'container-fail': containerFail}">
            ...
            <span class="slide-verify-slider-text Textfontsize">{{sliderText}}</span>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            drawBlock() {
                ...
                console.log('this.block_x',this.block_x)
                console.log('this.block_y',this.block_y)
            ...
            sliderDown(event) {
                if(!this.canMove) return //如果通过了按钮不允许在动
            ...
            bindEvents() {
                document.addEventListener('mousemove', (e) => {
                    ...
                    this.sliderMaskWidth = moveX + 62 + 'px';
                    console.log(this.sliderMaskWidth)
...
.infoClass{
    ...
    .slide-verify-slider-mask-item {
        ...
        height: 44px;
        /* background: #fff; */
        background: url('../assets/btn1.png') no-repeat center center;
